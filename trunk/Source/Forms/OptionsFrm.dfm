  ...
  object MainPages: TPageControl
    ...
    object tsExternal: TTabSheet
      ...
      object GroupBox1: TGroupBox
        ...
        object LDrawPathEdit: TJvDirectoryEdit
          Left = 117
          Top = 19
          Width = 420
          Height = 21
          DialogKind = dkWin32
          DialogText = 'Choose LDraw Library Location'
          TabOrder = 0
          OnChange = LDrawPathEditChange
        end
        object LDViewPathEdit: TJvDirectoryEdit
          Left = 117
          Top = 46
          Width = 420
          Height = 21
          DialogKind = dkWin32
          DialogText = 'Choose LDView Location'
          TabOrder = 1
          OnChange = LDViewPathEditChange
        end
        object MLCadPathEdit: TJvDirectoryEdit
          Left = 117
          Top = 73
          Width = 420
          Height = 21
          DialogKind = dkWin32
          DialogText = 'Choose MLCad Location'
          TabOrder = 2
          OnChange = MLCadPathEditChange
        end
        object LSynthPathEdit: TJvDirectoryEdit
          Left = 117
          Top = 100
          Width = 420
          Height = 21
          DialogKind = dkWin32
          DialogText = 'Choose lynthcp Location'
          DialogOptions = []
          TabOrder = 3
    ...
    object TabSheet5: TTabSheet
      ...
      object Panel5: TPanel
        ...
        object edSearchPath: TJvDirectoryEdit
          Left = 6
          Top = 45
          Width = 561
          Height = 21
          DialogKind = dkWin32
          DialogText = 'Choose Path'
          TabOrder = 7
