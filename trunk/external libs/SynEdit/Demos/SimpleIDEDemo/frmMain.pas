...
$Id: frmMain.pas,v 1.3 2004-03-01 22:05:17 billthefish Exp $
...
uses
  ...
  SynHighlighterPas, uSimpleIDEDebugger, Menus, SynEditMiscProcs;
...
begin
  ...
  begin
    ...
    if (fCurrentLine > 0) and (SynEditor.CaretY <> fCurrentLine) then
      SynEditor.CaretXY := MakeBufferCoord(1, fCurrentLine);
    SynEditor.InvalidateGutterLine(fCurrentLine);
    SynEditor.InvalidateLine(fCurrentLine);
  end;
end;
