...
$Id: SynEditMiscClasses.pas,v 1.2 2003-07-03 07:23:05 billthefish Exp $
...
type
  ...
  public
    ...
    procedure Replace(Replacement: string; ASynEdit :TObject); virtual; abstract; //slm 11/29/02    
